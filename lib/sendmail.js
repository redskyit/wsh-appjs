...
interface.VERSIONINFO = "sendmail Lib (sendmail.js) version 0.1";

/////////////////////////////////////////////////////////////////////////////////
// Send Mail Message
/////////////////////////////////////////////////////////////////////////////////

interface.sendmail = function(msg) {
  var ok, MAIL;
  ...
  if (interface.usePersitsMailSender) {

    // Use Persits AspEmail to send mail
    try {
      MAIL = interface.CreateObject("Persits.MailSender");
    } catch(e) {
